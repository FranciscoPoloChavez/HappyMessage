/*  Diego Armando Garcia Luna A01336163
    Francisco Polo Chavez A01335458
 */

package com.example.happymessage
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto.text = "Quiero una torta"
        Toast.makeText( this, "Yo pienso positivo", Toast.LENGTH_LONG).show()

        Log.i(packageName, "IoPP Loading")
        //Log.i("edu.daec.iopensopsotivo", msg:"IoPP Loading")
    ...
    fun back( view: View){
        texto.text = previousMessage()
    }

    fun nxt( view: View ){
        texto.text = nextMessage()
    }

    fun entr( view: View ){
        goToMsg()
        if (posicion < 0){
            Toast.makeText( this, "Escribe un numero mayor", Toast.LENGTH_LONG).show()
        }
        else if(posicion > database.size -1){
            Toast.makeText( this, "Escribe un numero menor", Toast.LENGTH_LONG).show()
        }
        else {
